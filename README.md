...
| **Cluster manager** | Accounts and OIDC sign-in, managed rooms, invitations, room-scoped API keys, and socket-node placement. Separate PostgreSQL service with a browser dashboard. | [`utilities/javascript/fates-edge-manager/`](utilities/javascript/fates-edge-manager/) |
