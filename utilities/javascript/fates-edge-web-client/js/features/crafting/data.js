...
export const FALLBACK_RECIPES = {
    ...
    'healing-draught': { id: 'healing-draught', name: '❤️‍🩹 Healing Draught', description: 'A powerful restorative.', effect: 'Restore 2 Fatigue when consumed during a short rest.', ingredients: ['Herbs', 'Honey', 'Distilled water'], skill: 'medicine', dv: 3, xpCost: 2, tier: 'standard', icon: '❤️‍🩹' },
    'restorative-salve': { id: 'restorative-salve', name: '🛡️ Restorative Salve', description: 'Thick, green ointment.', effect: 'Remove one ongoing minor Condition (e.g., Poisoned, Diseased) when applied.', ingredients: ['Herbs', 'Clean cloth', 'Olive oil'], skill: 'medicine', dv: 3, xpCost: 2, tier: 'standard', icon: '🛡️' },
