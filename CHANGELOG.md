...
### Chore
- sync A Roll of the Fallen revisions
- sync lockfile versions

## [5.10.8] - 2026-09-16

### Chore
- sync anthology apparatus corrections
- sync lockfile versions

## [5.10.7] - 2026-09-16

### Chore
- sync blade corrections and weekday sweep
- sync lockfile versions

## [5.10.6] - 2026-09-16

### Chore
- sync The Last Blade treatment and canon corrections
- sync lockfile versions

## [5.10.5] - 2026-09-16

### Chore
- sync The Daughter of Ahakar and regenerate manifests
- sync lockfile versions

## [5.10.4] - 2026-09-16

### Chore
- sync Paget corrections
- sync lockfile versions

## [5.10.3] - 2026-09-16

### Chore
- sync Paget and regenerate doc manifests
- sync sub-package lockfile versions to 5.10.2
- sync package-lock version to 5.10.2
...
### Chore
- sync The Widow's Walk revision from docs v0.23.1
...
### Chore
- sync Fenwood double-naming from docs v0.22.0

## [5.9.3] - 2026-09-15

### Chore
- sync trilogy revision from docs v0.21.2

## [5.9.2] - 2026-09-15

### Chore
- sync Diwan revision and four-book commentary from docs v0.21.1

## [5.9.1] - 2026-09-15

### Chore
- sync anthology from docs v0.21.0

## [5.9.0] - 2026-09-15

### Added
- The Diwan of Roads, from docs v0.20.0

## [5.8.5] - 2026-09-15

### Chore
- sync Lethai-al corrections from docs v0.19.1

## [5.8.4] - 2026-09-15

### Chore
- sync the Lethai shrine passage from docs v0.19.0

## [5.8.3] - 2026-09-14

### Chore
- sync Count Your Exits and Commentary from docs v0.18.0

## [5.8.2] - 2026-09-14

### Chore
- sync Utaran/Utaro language canon from docs v0.17.2
...
### Added
- publish Political Intrigue to the web client (docs v0.17.0)

## [5.7.2] - 2026-09-14

### Chore
- sync The Three Reckonings and rebuilt anthology from docs v0.16.0

## [5.7.1] - 2026-09-14

### Chore
- sync anthology and Kon'reh docs from fates-edge-docs v0.15.0

## [5.7.0] - 2026-09-14

### Added
- editorial pass on the Belworth books; add the commentary volume

## [5.6.1] - 2026-09-14

### Fixed
- refresh the Belworth novellas for the map and the two hands

## [5.6.0] - 2026-09-14

### Added
- publish Count Your Exits to the web client
...
### Added
- publish The Widow's Hand to the web client
...
### Other
- Mangled JSON prevented several apps from starting/building
- editorial passes on the documents.
- NPM install
...
### Other
- Updated the combat mini-feature.
...
### Other
- Document revision; formatting for actual humans to read.
- Added the guide to monks expansion

## [5.1.3] - 2026-09-09

### Fixed
- write the missing module stylesheets, and stop the board centring itself

### Other
- Added mobile interface. Concluded CSS sweep
- Added mobile interface. Concluded CSS sweep
- Manager work
- Updates to the core rulebook
- CSS audit/fix
...
### Other
- Updated/Fixed the SRD and added the SaaS manager
...
### Chore
- sync The Hollowed saga, Chain/Cord corrections and the rivalry table
...
### Added
- Cross-Resonance in the patron browser

### Fixed
- 18 legs carried a clock size that is not a clock
